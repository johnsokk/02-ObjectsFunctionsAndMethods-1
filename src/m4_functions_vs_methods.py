...
def try_methods_and_functions():
    ...
    """
    lucy = rg.SimpleTurtle()
    lucy.pen = rg.Pen('blue', 5)
    lucy.backward(150)
    lucy.speed = 1
    draw_many_squares(lucy, 2, 100, 30)
    lucy.speed = 5
    lucy.pen = rg.Pen('red', 5)
    draw_many_squares(lucy, 10, 50, 15)
    lucy.speed = 100
    lucy.pen = rg.Pen('red', 35)
    draw_many_squares(lucy, 8, 300, 60)
    lucy.pen = rg.Pen('black', 3)
    lucy.backward(200)
    lucy.draw_circle(30)
    lucy.draw_square(50)
    ###########################################################################
