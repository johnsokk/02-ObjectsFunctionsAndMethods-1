...
Authors: David Mutchler, Vibha Alangar, Matt Boutell, Dave Fisher,
         Aaron Wilkin, their colleagues, and Kaia Johnson.
...
def main():
    ...
    # better_draw_circles(rg.Point(0, 0), 30)
    even_better_draw_circles(rg.Point(0, 0), 20, 5, 'blue', 10)
    even_better_draw_circles(rg.Point(50, 100), 40, 10, 'magenta', 5)
    even_better_draw_circles(rg.Point(200, 50), 17, 12, 'green', 3)
    even_better_draw_circles(rg.Point(30, 0), 20, 16, 'yellow', 8)
